import {
  ...
  Select, type ListCollection,
} from '@chakra-ui/react'
import {
  statusCollection, dateCollection, shippingCollection, sortCollection,
  type FilterOption,
} from './data'
...
/** مودال فیلترهای سفارش — فقط در حالت موبایل/compact (Figma «Orders / Dialog / Filters»). */
export function OrderFilterModal({ open, onClose }: OrderFilterModalProps) {
  return (
        ...
        <Dialog.Positioner dir="rtl">
          <Dialog.Content maxW="448px" w="full" mx="4">
            ...
            <Dialog.Body px="6" pt="2" pb="4" display="flex" flexDirection="column" gap="4">
              ...
              <ModalSelect collection={shippingCollection} defaultValue="all" />
              <ModalSelect collection={statusCollection}   defaultValue="all" />
              <ModalSelect collection={dateCollection}     defaultValue="all" />
            </Dialog.Body>
