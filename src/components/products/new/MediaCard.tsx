...
export function MediaCard({
  ...
  return (
    <Box
      role="group"
      /* `className="group"` اجباری است، نه تزئینی: سلکتورِ `_groupHover` چاکرا
         `.group:hover &` است و با `role="group"` تنها کار نمی‌کند — بدون این،
         دستگیرهٔ کشیدن هرگز ظاهر نمی‌شد. */
      className="group"
      borderWidth="1px"
