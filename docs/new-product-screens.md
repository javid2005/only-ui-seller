...
| اطلاعات محصول | طلا (دستهٔ طلا → کارت اختصاصی طلا) | ✅ طراحی | ✅ طراحی | ✅ انجام شد (دسکتاپ) |
| اطلاعات محصول | ارزی (دلار + نرخ زنده + تبدیل حروف) | ✅ طراحی | ✅ طراحی | ✅ انجام شد (دسکتاپ) |
| اطلاعات محصول | دارای تنوع (قیمت/موجودی read-only) | ✅ طراحی | ✅ طراحی | 🟡 موجودی انجام شد؛ قیمت + setter تنوع مانده |
